...
urlpatterns = [
    ...
    path('comemnts/<int:id>/delete', delete_comment),
    path('comemnts/<int:id>/edit', edit_comment),
    path('comemnts/<int:id>/like', like_comment),
    path('comemnts/<int:id>/displke', dislike_comment),
    path('Error/', error),
